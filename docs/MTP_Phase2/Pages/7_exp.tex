...
\subsection{Motion Generation Experiments}
...
\subsection{Adversarial Control Experiments}
...
Run comparison followed the analyzer used in `eval_analyzer.py`. For a motion with cycle length $S_{\text{cycle}}$, the normalized survival metric is
\[
...
\paragraph{Case study I: phase-conditioned observations.}
...
\paragraph{Case study II: bilateral symmetry regularisation.}
