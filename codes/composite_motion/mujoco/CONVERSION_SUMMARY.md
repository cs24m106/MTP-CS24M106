...
- `config/locomotion_walk.py` - Example configuration file
...
```bash
python main.py config/iccgan/jaunty_walk.py --ckpt ./checkpoints/jaunty_walk --device 0
```

### Testing/Visualization

```bash
python main.py config/iccgan/jaunty_walk.py --ckpt ./checkpoints/jaunty_walk --test --render non
python main.py config/iccgan/jaunty_walk.py --ckpt ./checkpoints/jaunty_walk --test --render int
```
...
python main.py config/iccgan/punch_locomotion_walk.py --ckpt ./checkpoints/punch_walk --device 0

# Train goal-conditioned locomotion
python main.py config/locomotion_walk.py --ckpt ./checkpoints/locomotion_walk --device 0
```
